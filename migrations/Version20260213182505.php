 ...
 */
final class Version20260213182505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tournoi ADD cagnotte DOUBLE PRECISION DEFAULT NULL, DROP participants');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tournoi ADD participants INT DEFAULT NULL, DROP cagnotte');
    }
}
