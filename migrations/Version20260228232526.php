 ...
 */
final class Version20260228232526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE cart ADD CONSTRAINT FK_BA388B7A76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE cart_item CHANGE quantity quantity INT DEFAULT NULL, CHANGE added_at added_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE `order` CHANGE order_number order_number VARCHAR(255) DEFAULT NULL, CHANGE total_price total_price DOUBLE PRECISION DEFAULT NULL, CHANGE status status VARCHAR(50) DEFAULT NULL, CHANGE first_name first_name VARCHAR(255) DEFAULT NULL, CHANGE last_name last_name VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE address address LONGTEXT DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL, CHANGE postal_code postal_code VARCHAR(20) DEFAULT NULL, CHANGE phone phone VARCHAR(20) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F5299398A76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE order_item CHANGE product_name product_name VARCHAR(255) DEFAULT NULL, CHANGE product_price product_price DOUBLE PRECISION DEFAULT NULL, CHANGE quantity quantity INT DEFAULT NULL');
        $this->addSql('ALTER TABLE order_item ADD CONSTRAINT FK_52EA1F098D9F6D38 FOREIGN KEY (order_id) REFERENCES `order` (id)');
        $this->addSql('ALTER TABLE order_item ADD CONSTRAINT FK_52EA1F094584665A FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('ALTER TABLE product CHANGE name name VARCHAR(255) DEFAULT NULL, CHANGE description description LONGTEXT DEFAULT NULL, CHANGE price price NUMERIC(10, 2) NOT NULL, CHANGE stock stock INT DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD12469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        $this->addSql('ALTER TABLE product_rating CHANGE stars stars INT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart_item CHANGE quantity quantity INT NOT NULL, CHANGE added_at added_at DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE `order` CHANGE order_number order_number VARCHAR(255) NOT NULL, CHANGE total_price total_price DOUBLE PRECISION NOT NULL, CHANGE status status VARCHAR(50) NOT NULL, CHANGE first_name first_name VARCHAR(255) NOT NULL, CHANGE last_name last_name VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE address address LONGTEXT NOT NULL, CHANGE city city VARCHAR(255) NOT NULL, CHANGE postal_code postal_code VARCHAR(20) NOT NULL, CHANGE phone phone VARCHAR(20) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE order_item DROP FOREIGN KEY FK_52EA1F098D9F6D38');
        $this->addSql('ALTER TABLE order_item DROP FOREIGN KEY FK_52EA1F094584665A');
        $this->addSql('ALTER TABLE order_item CHANGE product_name product_name VARCHAR(255) NOT NULL, CHANGE product_price product_price DOUBLE PRECISION NOT NULL, CHANGE quantity quantity INT NOT NULL');
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04AD12469DE2');
        $this->addSql('ALTER TABLE product CHANGE name name VARCHAR(255) NOT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE price price DOUBLE PRECISION NOT NULL, CHANGE stock stock INT NOT NULL, CHANGE image image VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE product_rating CHANGE stars stars INT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
