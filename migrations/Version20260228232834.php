 ...
 */
final class Version20260228232834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE order_number order_number VARCHAR(255) DEFAULT NULL, CHANGE total_price total_price NUMERIC(10, 2) NOT NULL, CHANGE status status VARCHAR(50) DEFAULT NULL, CHANGE first_name first_name VARCHAR(255) DEFAULT NULL, CHANGE last_name last_name VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE address address LONGTEXT DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL, CHANGE postal_code postal_code VARCHAR(20) DEFAULT NULL, CHANGE phone phone VARCHAR(20) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F5299398A76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE order_item CHANGE product_name product_name VARCHAR(255) DEFAULT NULL, CHANGE product_price product_price NUMERIC(10, 2) NOT NULL, CHANGE quantity quantity INT DEFAULT NULL');
